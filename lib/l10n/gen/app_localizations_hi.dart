...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get settingsNotifLocalOnly =>
      'रिमाइंडर केवल इस डिवाइस पर शेड्यूल किए जाते हैं — किसी सर्वर से नहीं भेजे जाते। यदि आप कोई दूसरा फ़ोन इस्तेमाल करें या ऐप फिर से इंस्टॉल करें, तो ये आप तक नहीं पहुंचेंगे, और फ़ोन को दोबारा चालू करने पर भी ये मिट सकते हैं — बैठक या ऋण टैब को फिर से खोलने पर ये फिर से सही हो जाते हैं। यदि कोई बैठक रद्द कर दी जाती है, तो केवल इसी डिवाइस का रिमाइंडर तुरंत रद्द होता है — किसी अन्य सदस्य के फ़ोन पर पुराना रिमाइंडर तब तक दिख सकता है जब तक वह बैठक टैब फिर से न खोले। ऋण के लिए भी ऐसा ही है: यदि आपका लीडर अपने फ़ोन पर आपका आखिरी भुगतान दर्ज करती है, तो आपके फ़ोन पर देय-तिथि रिमाइंडर तभी हटेगा जब आप ऋण टैब फिर से खोलेंगी।';
  ...
  @override
  String get adminDashboardSystemUptimeLabel => 'शेड्यूलर स्थिति';
  ...
  String marketplaceOrdersSpendSummary(String total, int count) {
    ...
    return '$count डिलीवर किए गए $_temp0 पर ₹$total खर्च किए गए';
  }
  ...
  @override
  String get productDetailScanToPay => 'या स्कैन करके भुगतान करें';

  @override
  String productDetailQrCodeSemantics(String upiId, String amount) {
    return '$upiId के लिए UPI भुगतान QR कोड, राशि ₹$amount';
  }
  ...
  String meetingScheduleDuplicateConfirmMessage(String date) {
    return 'इस SHG की $date को पहले से ही एक बैठक निर्धारित है। क्या उसी दिन के लिए एक और बैठक निर्धारित करें?';
  }
  ...
  @override
  String get meetingScheduleSelectShgHint => 'एक SHG चुनें';

  @override
  String get meetingScheduleSelectShgError =>
      'इस बैठक को शेड्यूल करने के लिए एक SHG चुनें।';
