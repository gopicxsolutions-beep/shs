...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get settingsNotifLocalOnly =>
      'रिमाइंडर केवल इस डिवाइस पर शेड्यूल किए जाते हैं — किसी सर्वर से नहीं भेजे जाते। यदि आप कोई दूसरा फ़ोन इस्तेमाल करें या ऐप फिर से इंस्टॉल करें, तो ये आप तक नहीं पहुंचेंगे, और फ़ोन को दोबारा चालू करने पर भी ये मिट सकते हैं — बैठक या ऋण टैब को फिर से खोलने पर ये फिर से सही हो जाते हैं। यदि कोई बैठक रद्द कर दी जाती है, तो केवल इसी डिवाइस का रिमाइंडर तुरंत रद्द होता है — किसी अन्य सदस्य के फ़ोन पर पुराना रिमाइंडर तब तक दिख सकता है जब तक वह बैठक टैब फिर से न खोले।';
